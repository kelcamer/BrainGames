...
export const BADGES = [
  ...
  { id: "first-trace", label: "First Card Catalog", test: (s) => s.best.tracemap.plays >= 1 },
  { id: "first-hard", label: "First Trace Map Run", test: (s) => s.best.tracemaphard.plays >= 1 },
  ...
  { id: "first-ebbflow", label: "First Ebb and Flow Run", test: (s) => s.best.ebbflow.plays >= 1 },
  { id: "ebbflow-25", label: "Flexible Mind (25 correct)", test: (s) => s.best.ebbflow.bestScore >= 25 },
  { id: "first-wayfinder", label: "First Wayfinder Run", test: (s) => s.best.wayfinder.plays >= 1 },
