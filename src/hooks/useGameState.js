...
function defaultState() {
  return {
    ...
    best: {
      ...
      fourpeaks: { accuracy: 0, maxLandmarks: 0, plays: 0 },
      shortcut: { shortcutsFound: 0, plays: 0 },
    },
    streak: 0,
    lastPlayDate: null,
    totalSessions: 0,
...
export const BADGES = [
  ...
  { id: "first-peaks", label: "First Peaks Run", test: (s) => s.best.fourpeaks.plays >= 1 },
  { id: "peaks-5", label: "5-Peak Panorama", test: (s) => s.best.fourpeaks.maxLandmarks >= 5 },
  { id: "first-shortcut", label: "First Shortcut Run", test: (s) => s.best.shortcut.plays >= 1 },
  { id: "cartographer", label: "Cartographer", test: (s) => s.best.shortcut.shortcutsFound >= 1 },
